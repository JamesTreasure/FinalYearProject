...
However, as shown by \cite{lemon1998insufficiency}, linear diagrams do not succsessfully manage to circumvent the same limitations that planar figures are succeptible to. 
...
The issue with this form of representation is the notation used is not intuitive. Cateogrical Pattern Diagrams require the person to learn a whole new notation before they can begin to reason about the syllogism that it is representing.
